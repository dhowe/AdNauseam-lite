...
The source code lives in the [AdNauseam](https://github.com/mneunomne/AdNauseam) repository, under `platform/mv3`. This repository holds it as a git submodule and publishes the release packages.
